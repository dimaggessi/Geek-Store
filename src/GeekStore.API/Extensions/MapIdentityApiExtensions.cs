...
public static class IdentityApiEndpointRouteBuilderExtensions
{
    ...
    public static IEndpointConventionBuilder MapGeekStoreCustomIdentityApi<TUser>(this IEndpointRouteBuilder endpoints)
        where TUser : class, new()
    {
        ...
        // ----------------------------------------------------------
        // Removed /register  (Custom AuthController Register option)
        // ----------------------------------------------------------

        routeGroup.MapPost("/logout", async Task<Results<NoContent, EmptyHttpResult, ProblemHttpResult>>
        ...
        routeGroup.MapPost("/change-info", async Task<Results<Ok<InfoResponse>, ValidationProblem, NotFound>>
