...
public class GetOrderByIdAndCustomerEmailQueryValidator : AbstractValidator<GetOrderByIdAndCustomerEmailQuery>
{
    public GetOrderByIdAndCustomerEmailQueryValidator()
    {
